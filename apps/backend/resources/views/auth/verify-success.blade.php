...
<head>
    ...
    <style>
        ...
        .icon { color: #10b981; font-size: 4rem; margin-bottom: 1rem; }
...
<body>
    <div class="card">
        ...
        <p>Chúc mừng! Tài khoản của bạn đã được kích hoạt thành công. Bây giờ bạn có thể đăng nhập vào ứng dụng.</p>
        <a href="{{ config('app.frontend_url') ?: '#' }}" class="btn">Đi tới Đăng nhập</a>
    </div>
</body>
</html>
