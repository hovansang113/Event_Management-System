...
<head>
    <meta charset="UTF-8">
    <title>Spot Opened - You're In!</title>
    <style>
        ...
        .badge { display: inline-block; padding: 4px 12px; border-radius: 9999px; font-size: 13px; font-weight: 600; margin-top: 8px; background-color: #d1fae5; color: #065f46; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Great news! A spot has opened up and you've been moved from the waitlist to <strong>Confirmed</strong> for the event below.</p>
